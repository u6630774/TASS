...
def _segm_resnet(name, backbone_name, num_classes, output_stride, pretrained_backbone,decays,beta_value):
...
def _load_model(arch_type, backbone, num_classes, output_stride, pretrained_backbone,decays=[1.0, 0.85, 0.65, 0.15], beta_value:float=25.0):
# def _load_model(arch_type, backbone, num_classes, output_stride, pretrained_backbone,decays, beta_value):

    if backbone=='mobilenetv2':
        model = _segm_mobilenet(arch_type, backbone, num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
    elif backbone.startswith('resnet'):
        # model = _segm_resnet(arch_type, backbone, num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
        model = _segm_resnet(arch_type, backbone, num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone,decays = decays,beta_value = beta_value)
...
def deeplabv3plus_resnet50(num_classes=21, output_stride=8, pretrained_backbone=True,decays=[1.0, 0.85, 0.65, 0.15], beta_value:float=25.0):
    """Constructs a DeepLabV3 model with a ResNet-50 backbone.
    ...
    return _load_model('deeplabv3plus', 'resnet50', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone,decays = decays,beta_value = beta_value)

# def deeplabv3plus_resnet101(num_classes=21, output_stride=8, pretrained_backbone=True,decays=[1.0, 0.85, 0.65, 0.15], beta_value:float=25.0):
def deeplabv3plus_resnet101(num_classes=21, output_stride=8, pretrained_backbone=True,decays=[1.0, 0.85, 0.65, 0.15], beta_value:float=25.0):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    # return _load_model('deeplabv3plus', 'resnet101', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone,decays,beta_value)
    return _load_model('deeplabv3plus', 'resnet101', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone,decays = decays,beta_value = beta_value)
