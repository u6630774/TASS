...
# modelpr50.load_state_dict( torch.load( "checkpoints/best_deeplabv3plus_resnet50_voc_os16.pth")['model_state'])
...
def main():
    ...
    if opts.bayesian_opt:
        ...
        resnet_opt.maximize(n_iter=5000)
    ...
    if opts.test_only:
        ...
        val_score, ret_samples = validate(
            opts=opts, model=model,model1=modelpm, loader=val_loader, device=device, metrics=metrics, ret_samples_ids=vis_sample_id)
...
# =============================================================================
            ...
            if (cur_itrs) % opts.val_interval == 0:
                ...
                model.eval()
                val_score, ret_samples = validate(
                    opts=opts, model=model,model1=modelpm, loader=val_loader, device=device, metrics=metrics,
